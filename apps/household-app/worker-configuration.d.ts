/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17873be208da0e40eaa14ace6eaf38f8)
...
declare namespace Cloudflare {
	interface Env {
		...
		PUBLIC_ENV__BETTER_AUTH_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PUBLIC_ENV__BETTER_AUTH_URL" | "HYPERDRIVE_ID">> {}
}
